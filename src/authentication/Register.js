          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:bg-indigo-600 shadow-sm rounded-lg transition duration-300"
              />
            </div>
